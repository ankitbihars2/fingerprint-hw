...
def hex_txt_to_image(txt_file, width=256, height=144, output="fingerprint9.png"):
    ...
    REAL_WIDTH = 128   # half of 256
    REAL_HEIGHT = 144  # keep same

    img = np.frombuffer(data_bytes[:REAL_WIDTH * REAL_HEIGHT], np.uint8)
    img = img.reshape((REAL_HEIGHT, REAL_WIDTH))
